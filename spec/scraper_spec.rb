...
describe "Scraper" do
 ...
 :bio=>
  ...
  describe "#scrape_index_page" do
    xit "is a class method that scrapes the student index page ('./fixtures/student-site/index.html') and a returns an array of hashes in which each hash represents one student" do
