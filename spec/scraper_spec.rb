...
describe "Scraper" do
  ...
  let!(:student_index_array) {[{:name=>"Joe Burgess", :location=>"New York, NY", :profile_url=>"http://127.0.0.1:8080/code/labs/oo-student-scraper-v-000/fixtures/student-site/students/joe-burgess.html"},
                               {:name=>"Mathieu Balez", :location=>"New York, NY", :profile_url=>"http://127.0.0.1:8080/code/labs/oo-student-scraper-v-000/fixtures/student-site/students/mathieu-balez.html"},
                               {:name=>"Diane Vu", :location=>"New York, NY", :profile_url=>"http://127.0.0.1:8080/code/labs/oo-student-scraper-v-000/fixtures/student-site/students/diane-vu.html"}]}
