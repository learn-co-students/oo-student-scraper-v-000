...
def self.scrape_index_page(index_url)
  ...
  #binding.pry
  student = {
  :name => search("h4.student-name").text,
  :location => student_value.css("div.student-card")each.search("p.student-location").text,
  :profile_url => student_value.css("div.student-card")each.search("a href")
  }
