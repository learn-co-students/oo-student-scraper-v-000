...
class Scraper
    ...
    def self.scrape_profile_page(profile_url)
        ...
        student_info[:bio] = page.css("div.bio-content.content-holder div.description-holder p").text if page.css("div.bio-content.content-holder div.description-holder p")
