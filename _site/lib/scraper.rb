...
class Scraper
  ...
  def self.scrape_index_page(index_url)
    # student name: individual_students.css(".student-name").text
    # student location: individual_students.css(".student-location").text
    # student url: individual_students.css("div.student-card a").attribute("href").value
